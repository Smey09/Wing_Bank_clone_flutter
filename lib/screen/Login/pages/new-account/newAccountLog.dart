...
import 'package:wink_bank_clone/screen/Login/pages/new-account/item-newAccontLog.dart';
import 'package:wink_bank_clone/theme/colors.dart';

class NewAccountLog extends StatelessWidget {
  const NewAccountLog({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      const CardItemNewAccountLog(
                        ...
                        title: "Term Deposit",
                        description:
                            "Earn a high income up to 9.00% p.a. as interest from your deposit amount",
                      ),
                      const CardItemNewAccountLog(
